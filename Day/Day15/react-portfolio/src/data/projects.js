...
export const projectsData = [
  {
   id: 1,
    title: 'QuizClash',
    description: 'Real-time multiplayer quiz app with live rounds',
    longDesc:
      'A MERN stack trivia app where players join live quiz rooms, compete in real-time rounds via Socket.io, and climb a leaderboard based on speed and accuracy.',
